...
<table style="margin-left: 40%;">
	<tr align='center' height='20'>
		<td>
			...
			[이전]&nbsp;
			<%}else{ %>
			<a href="javascript:AJ('mReview?page=<%=nowpage-1 %>','#printP')">[이전]</a>&nbsp;
			<%} %>
			<%for(int a=startpage; a<=endpage; a++){ 
				...
				<a href="javascript:AJ('mReview?page=<%=a %>','#printP')">[<%=a %>]</a>
				&nbsp;
				<%} %>
			<%} %>
			<%if(nowpage>=maxpage){ %>
...
<!-- <form action="mReview_form" method="post"> -->
	<a href="javascript:AJ('mReview_form','#printP')"><input type="button" value="글쓰기" /></a>
<!-- </form> -->
</c:if>
</body>
<script>
