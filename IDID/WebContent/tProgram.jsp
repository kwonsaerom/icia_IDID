...
<title>Insert title here</title><link rel="stylesheet" media="screen" href="http://fonts.googleapis.com/earlyaccess/jejugothic.css"/>
<style>
body{
...
<br/>
   ...
   <table>
      ...
      <tr>
         <td colspan="2">
         <br/>
            프로그램 소개(500자 이내):<br/><br/><textarea name="pInfo" rows="10" cols="97"></textarea>
         </td>
      </tr>
      <tr id="price">
