...
<style>
#homeInfo {width:300px; height:300px; border-radius:300px; margin:0 auto; overflow:hidden;}
#homeInfo img {height:auto; width:200px;}
.idid{
...
<body>
   ...
   <br/>
      ...
      <br/>
      <img id="homeInfo" alt="소개이미지" src="image/운동하자.jpg">
   </div>
   <div class="information">
      <h2 class="index">01</h2>
      <h3>친구와의 약속, 잦은 야근과 회식, 작심삼일에 그치는 운동은 늘 다이어트 의지를 흔들곤 합니다. 그럴 땐 트레이너와 이야기를 나누세요.
         IDID가 흔들리는 당신의 마음을 잡아드립니다.</h3>
      <h3>끊임없는 피드백을 통해, 체계적인 식단과 효율적인 운동 등 다양한 프로그램들을 통해 코칭 받으실 수 있습니다.</h3><br/>
      <h2 class="index">02</h2>
      <h3>굶는 다이어트를 지양하고 놀라운 식습관 변화를 이끌어내는 생활밀착형 사이트로 트레이너들이 직접  짜주는 식단과 한 눈에 보기 쉬운 그래프를 통해 여러분의 변화를 직접 확인해보세요.</h3>
